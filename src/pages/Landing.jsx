...
import { Instagram, Facebook, Twitter, Mail, Phone, UserStar } from 'lucide-react';
import { Link } from 'react-router-dom';

const BrothersGym = () => {
  const trainers = [
    {
      name: 'Alex "The Anvil" Stone',
      specialty: 'Strength & Powerlifting',
      bio: 'Alex has been training for over 15 years, specializing in maximizing raw strength and power.',
      icon: <UserStar size={260} strokeWidth={1.5} />,
    },
    {
      name: 'Sarah "Iron" Lee',
      specialty: 'Bodybuilding & Nutrition',
      bio: 'Sarah is a certified bodybuilder with a passion for helping clients sculpt their physique through precise training and diet.',
      icon: <UserStar size={260} />,
    },
    {
      name: 'Marcus "Titan" Reed',
      specialty: 'CrossFit & Conditioning',
      bio: 'Marcus brings a high-energy approach to every session, pushing members to their limits to achieve peak physical condition.',
      icon: <UserStar size={260} />,
    },
  ];
  ...
  const sampleGym = './sample_gym.jpg';
    ...
    <div className="bg-black text-gray-200 font-sans leading-relaxed">
      ...
      <nav className="fixed w-full z-50 bg-opacity-80 backdrop-filter backdrop-blur-sm shadow-lg">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <a href="#" className="text-3xl font-bold text-red-600 font-display border p-2 rounded-lg border-red-600">
            Brothers
          </a>
          <div className="hidden md:flex space-x-8 text-sm uppercase">
            ...
            <a
              href="#join"
              className="py-1 px-4 border-2 border-red-600 text-red-600 rounded-full hover:bg-red-600 hover:text-white transition-all duration-300"
            >
              Join Now
            </a>
          </div>
      ...
      <header
        ...
        style={{
          backgroundImage: "url('/landing_1.jpg')", // ✅ fix: must be a string
      ...
      >
        ...
        <div className="relative z-10 p-6 md:p-12">
          <h1 className="text-4xl md:text-6xl lg:text-8xl font-black uppercase text-red-600 drop-shadow-lg">
            Brothers
          </h1>
          <h2 className="text-xl md:text-3xl mt-4 font-semibold tracking-wider text-gray-300">
            Forge Your Strength. Build Your Legacy.
          </h2>
          <p className="mt-6 md:mt-8 max-w-2xl mx-auto text-base md:text-lg">
            A hardcore training facility dedicated to bodybuilding and powerlifting. We provide the tools, the atmosphere,
            and the expertise to help you achieve your most ambitious fitness goals.
          </p>
          <a
            href="#join"
            className="mt-8 inline-block px-12 py-4 border-red-700 border-2 text-white font-bold uppercase tracking-wide rounded-full shadow-lg hover:bg-red-700 transition"
          >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row items-center md:space-x-12">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <img src={sampleGym} alt="Gym Interior" className="rounded-lg shadow-xl" />
            </div>
            <div className="md:w-1/2">
              <p className="text-lg text-gray-400 mb-6">
                Brothers is not just a gym; it's a sanctuary for those committed to the iron. Founded by bodybuilders for
                bodybuilders, we've stripped away the fluff and focused on what truly matters: heavy weights, proper form,
                and an environment that fuels progress.
              </p>
              <p className="text-lg text-gray-400">
                Our facility is equipped with state-of-the-art power racks, dumbbells up to 200lbs, and specialized machines
                designed to target every muscle group. We believe in the grind, the sweat, and the unwavering dedication it
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {trainers.map((trainer, index) => (
              <div
                key={index}
                className="bg-gray-900 rounded-lg shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300"
              >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div
                key={index}
                className="relative bg-gray-900 rounded-lg p-8 shadow-xl border-t-4 border-red-600 transition-transform duration-300 hover:scale-105"
              >
                ...
                <a
                  href="#join"
                  className="block w-full text-center py-3 bg-red-600 text-white font-bold uppercase rounded-full shadow-lg hover:scale-105 transition-transform duration-300"
                >
                  Select Plan
                </a>
              </div>
            ...
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <div className="space-y-4">
                <p className="flex items-center text-gray-300">
                  <Mail size={20} className="mr-3 text-red-600" /> info@brothersgym.com
                </p>
                <p className="flex items-center text-gray-300">
                  <Phone size={20} className="mr-3 text-red-600" /> (123) 456-7890
                </p>
              </div>
