...
const BrothersGym = () => {
  ...
  const sampleGyn = "src/assets/images/sample_gym.jpg"
  ...
  return (
    <div className="bg-black text-gray-200 font-sans leading-relaxed">
      ...
      {/* Hero Section */}
      <header id="hero" className="relative h-screen flex items-center justify-center text-center text-white bg-cover bg-center bg-[url('src/assets/images/landing_1.jpg')]">
